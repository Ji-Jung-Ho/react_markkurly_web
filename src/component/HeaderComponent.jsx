...
export default function HeaderComponent ({$path, introMainFn, subMain1Fn, subMain2Fn, subMain3Fn, subMain4Fn, memberSignUpFn, memberSignInFn}) {
        ...
        <div className="row1">
            <div className="row1-1">
                <ul id="topMenu" className="member-bar">
                    <li><a href="!#" className="on" onClick={onClickSignUp}>회원가입</a></li>
                    <li><i>|</i></li>
                    <li><a href="!#" onClick={onClickSignIn}>로그인</a></li>
                    <li><i>|</i></li>
                    <li><a href="!#">고객센터<img src={`${$path}img/header/ico_down_16x10.png`} alt=""/></a>
            ...
            <div className="row1-2">
                <div className="left">
                    <ul>
                        <li>
                            <h1>
                                <a href="!#" onClick={onClickIntroMain}><img src={`${$path}img/header/logo_kurly.svg`} alt="컬리 홈"/><span>마켓컬리</span></a>
                            </h1>
                        </li>
                        <li>
                            <i>|</i>
                        ...
                        <li>
                            <a href="!#">뷰티컬리<img src={`${$path}img/header/n.svg`} alt=""/></a>
                        </li>
                    </ul>
                </div>
                <div className="center">
                    <input type="text" name="search" id="search" placeholder="검색어를 입력해주세요"/>
                    <a href="!#" className="search-btn"><img src={`${$path}img/header/search.svg`} alt=""/></a>
                </div>
                <div className="right">
            ...
            <div className="row2-container">
                <div className="left">
                    <a href="!#" className="menu-bar-btn">
                        <img src={`${$path}img/header/menu_bar.svg`}  alt=""/>
                        <span>카테고리</span>
                            ...
                            <div className="category-option">
                                <ul>
                                    <li className="newyear">
                                        <div className="wrap">
                                            <img src={`${$path}img/header/2023year.webp`} className="newyear" alt=""/>
                ...
                <div className="center">
                    <nav id="nav">
                        <span><a href="!#" onClick={onClickSubMain1}>신상품</a></span>
                        <span><a href="!#" onClick={onClickSubMain2}>베스트</a></span>
                        <span><a href="!#" onClick={onClickSubMain3}>알뜰쇼핑</a></span>
                        <span><a href="!#" onClick={onClickSubMain4}>특가/혜택</a></span>
                    </nav>
                </div>
                <div className="right">
                    <a href="!#">
